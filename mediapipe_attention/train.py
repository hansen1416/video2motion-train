...
class DoubleAttention(nn.Module):
    def __init__(
        ...
        # 33 joints in mediapipe
        self.inner_seq_len = 33
        ...
        # 16 bones in target and 3 coordinates
        self.outter_linear_output = 16 * 3 * self.outter_seq_len
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        return output.view(-1, self.outter_seq_len, 16, 3)
